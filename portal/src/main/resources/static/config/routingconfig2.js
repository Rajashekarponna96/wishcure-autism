...
myApp.config(function($stateProvider, $urlRouterProvider,$httpProvider) {
	...
	}).state('main.patientviewtabs.patient_evaluation_sheet.mentalReportGraph', {
	...
	.state('main.patientviewtabs.patient_evaluation_sheet.evaluationTemplateCategories', {
...
params:{
	...
	.state('main.internalDashboardLogs', {
	   ...
	   inActiveAdminsAndSuperAdmin:null
	...
	}).state('main.addIsaaBehaviourLookUP', {
		url : '/addIsaaBehaviourLookUP',
		templateUrl : 'views/isaaBehaviour/addIsaaBehaviourLookUP.html',
		controller : 'isaaBehaviourlookUPCtrl'
	}).state('main.updateIsaaBehaviourLookUp', {
		url : '/updateIsaaBehaviourLookUp',
		templateUrl : 'views/isaaBehaviour/updateIsaaBehaviourLookUp.html',
		controller : 'isaaBehaviourlookUPCtrl',
		params:{
		...
		controller : 'isaaBehaviourQuestionLookupCtrl'
	}).state('main.NICHQParentCategoryLookup', {
		url : '/NICHQParentCategoryLookup',
		templateUrl : 'views/nichq/NICHQParentCategoryLookup.html',
		controller : 'nichqCtrl'
	}).state('main.updatenichqparent', {
		url : '/updateNICHQParentCategoryLookup',
		templateUrl : 'views/nichq/updateNICHQParentCategoryLookup.html',
		controller : 'nichqCtrl',
		params:{
			nichqobject:null
		}
	...
	.state('main.separationprocess', {
		...
		url : '/addSubCategory',
		templateUrl : 'views/masters/category/addSubCategory.html',
