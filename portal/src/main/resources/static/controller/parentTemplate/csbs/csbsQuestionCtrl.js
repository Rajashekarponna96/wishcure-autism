function csbsQuestionCtrl($scope, $state, csbsQuestionLookupService,csbsLookupservice, $rootScope,$stateParams) {
...
angular.module("HealthApplication")
		.controller("csbsQuestionCtrl", csbsQuestionCtrl);