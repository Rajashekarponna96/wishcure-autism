...
@Entity
public class StandardScore implements Serializable {
	...
	private SpeechTherapyTemplate speechTherapyTemplate;
	...
	@JsonIgnore
	@ManyToOne
	public SpeechTherapyTemplate getSpeechTherapyTemplate() {
		return speechTherapyTemplate;
	}

	@JsonProperty
	public void setSpeechTherapyTemplate(SpeechTherapyTemplate speechTherapyTemplate) {
		this.speechTherapyTemplate = speechTherapyTemplate;
	}
