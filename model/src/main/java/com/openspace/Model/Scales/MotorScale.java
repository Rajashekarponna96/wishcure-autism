...
@Entity
public class MotorScale implements Serializable {
	...
	@ManyToOne
	public MotorCluster getMotorCluster() {
		return motorCluster;
	}

	@JsonProperty
	public void setMotorCluster(MotorCluster motorCluster) {
		this.motorCluster = motorCluster;
	}
